                           ...
                           <div className="grid grid-cols-1 md:grid-cols-4 w-full">
                              <div className="md:col-span-2">
                                 <div className="flex flex-col max-[500px]:items-center gap-3">
                                    ...
                                    <h6 className="font-normal text-base leading-7 text-gray-500 capitalize">
                                       {cart?.category?.name}
                                    </h6>
                                    <div
                                       onClick={() => removeProduct(cart?.id)}
                                       className="font-medium text-base leading-7 cursor-pointer text-gray-600 transition-all duration-300 group-hover:text-indigo-600">
                                       Remove
                                    </div>
                                 </div>
                              </div>
